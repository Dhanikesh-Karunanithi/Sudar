...
$string['createtitle'] = 'Sudar Create';
$string['simtitle'] = 'SudarSim roleplay';
$string['simdesc'] = 'Practice customer conversations with AI coaching feedback.';
$string['simerror'] = 'Could not launch SudarSim. Check ALP settings and scenario.';
$string['createdesc'] = 'Generate quizzes, interactives, and flashcards with AI. Download SCORM 1.2 to add to your course.';
$string['createerror'] = 'Could not open Sudar Create. Check ALP API key and user mapping in Sudar Studio.';
