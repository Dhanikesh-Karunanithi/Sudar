...
description: Bounded automation with an audit trail, not “extra chatbots”.
audience: admin
...
In Studio, **Organization → Sudar Agents** shows recent runs. **Run cohort pulse** triggers a path-and-cohort rollup for your org. Admins can enable or disable Agents and individual features under **Org settings**.
