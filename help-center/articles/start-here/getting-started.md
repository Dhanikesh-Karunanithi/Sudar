...
Sudar splits work across **Sudar Studio** (authors and admins), **Sudar Learn** (learners), and **Sudar Intelligence** (heavy AI tasks). Studio and Learn share one **Supabase** project so courses and telemetry stay aligned.

Suggested order:

1. **Identity and database** — Create a Supabase project; configure Auth for your learners and admins.
2. **Session/auth for each app** — Configure each Next.js app with the correct Supabase and session secrets per your deployment checklist.
