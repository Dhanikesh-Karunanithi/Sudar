        ...
        <div className="max-w-sm w-full text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-500 text-sm leading-relaxed">
              We sent a confirmation link to <span className="text-slate-800 font-medium">{email}</span>. Click it to
              activate your account and start learning.
            </p>
          </div>
          <Link href="/login" className="inline-block text-primary hover:opacity-90 text-sm font-medium transition-colors">
            Back to sign in
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-md space-y-8">
        ...
        <p className="text-center text-slate-400 text-xs">© 2026 Sudar · Learns with you, for you.</p>
      </div>
    </div>
  )
}
