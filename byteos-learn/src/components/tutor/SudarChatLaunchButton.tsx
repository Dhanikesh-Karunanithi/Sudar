  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        'rounded-2xl border border-border/80 bg-card/90 text-primary shadow-xl backdrop-blur-md',
        'transition-[box-shadow,background-color,border-color] duration-300',
        'hover:bg-card hover:border-border',
        'hover:shadow-[0_14px_40px_-12px_color-mix(in_oklab,var(--primary)_22%,transparent)]',
