...
// Keep in sync with sudar-ecosystem-demo/src/lib/demoMotion.ts (hero uses fixed timings, no cinematic playback rate).

import { useEffect, useState } from "react";

/** Character-by-character typing for cinematic prompts */
export function useTypingText(fullText: string, active: boolean, msPerChar = 22) {
...
export function useCountUp(target: number, durationMs = 900, active = true) {
