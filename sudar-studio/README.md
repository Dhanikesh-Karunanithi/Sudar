...
`npm run dev` now auto-starts SudarVid (if it is not already running) and then starts Studio.
If you need to run Studio without auto-starting SudarVid, use `npm run dev:next-only`.
