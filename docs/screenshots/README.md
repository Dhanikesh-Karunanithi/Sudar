...
3. **Studio path or compliance** — Path editor with assigned learners, or Compliance view (overdue / at-risk / on-track).

Name files clearly (e.g. `learn-dashboard.png`, `course-viewer-sudar.png`, `studio-compliance.png`) and link or embed them in the main README if desired.
