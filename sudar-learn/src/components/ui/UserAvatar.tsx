...
export interface UserAvatarProps {
  ...
  size?: UserAvatarSize
  className?: string
  /** Accessible label; defaults to full name or "User avatar" */
  label?: string
}
...
export function UserAvatar({
  ...
  if (avatarUrl) {
    return (
      ...
      >
        {/* eslint-disable-next-line @next/next/no-img-element -- remote Supabase URLs; avoids host allowlist per project */}
