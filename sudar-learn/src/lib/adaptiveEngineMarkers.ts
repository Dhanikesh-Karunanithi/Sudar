 ...
 * Learner UI renders these as callouts — they are not meant to appear as raw bracket syntax.
 */
...
/** Keeps fenced ``` blocks out of marker parsing so code samples are not corrupted. */
