...
import { syncCourseEnrollmentProgress } from '@/lib/learner/courseEnrollmentProgress'
...
export async function POST(request: NextRequest) {
  ...
  // On module_complete — update enrollment progress (distinct modules, not raw event rows)
  if (event_type === 'module_complete' && course_id) {
    await syncCourseEnrollmentProgress(admin, user.id, course_id)
  }
