    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#050505] p-6">
        <div className="max-w-sm space-y-4 text-center">
          ...
          <p className="text-sm text-zinc-500">We&apos;ll email you an invite code when early access opens for your account.</p>
          <Link href="/signup" className="inline-block text-sm text-[#FF4500]/90 hover:text-[#FF5722]">
            Back to signup
          </Link>
        </div>
      </div>
    ...
    <div className="flex min-h-screen items-center justify-center bg-[#050505] p-6">
      <div className="w-full max-w-md space-y-6 rounded-2xl border border-white/[0.08] bg-zinc-950/60 p-8">
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <p className="text-sm text-zinc-500">Sudar is in early access. Request an invite and we&apos;ll send you a code.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input
            ...
            placeholder="How will you use Sudar? (optional)"
            className="w-full rounded-lg border border-white/[0.08] bg-white/[0.04] px-3.5 py-2.5 text-sm text-white"
          />
          <button
            type="submit"
