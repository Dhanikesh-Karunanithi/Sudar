      ...
      <div className="w-full max-w-lg">
          ...
          <div className="bg-card border border-border rounded-2xl p-7 shadow-sm space-y-6">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full px-3.5 py-3 border border-border rounded-xl text-sm bg-muted text-foreground placeholder:text-muted-foreground caret-primary focus:outline-none focus:border-primary resize-none"
              />
            </div>
          ...
          <div className="bg-card border border-border rounded-2xl p-7 shadow-sm space-y-6">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full px-3.5 py-3 border border-border rounded-xl text-sm bg-muted text-foreground placeholder:text-muted-foreground caret-primary focus:outline-none focus:border-green-400 resize-none"
              />
            </div>
        ...
        {step === 6 && (
          <div className="text-center space-y-6">
            <div
              className={cn(
                'relative mx-auto flex h-20 w-20 items-center justify-center overflow-hidden rounded-card-xl',
                'bg-gradient-to-br from-emerald-500 via-green-500 to-emerald-600',
                'shadow-lg shadow-emerald-500/35 ring-1 ring-inset ring-white/35',
                'dark:from-emerald-600 dark:via-green-600 dark:to-emerald-800 dark:shadow-emerald-950/60 dark:ring-white/15',
              )}
            >
              {saving ? (
                <>
                  <div
                    className="absolute inset-0 rounded-card-xl bg-white/25 backdrop-blur-md dark:bg-black/30"
                    aria-hidden
                  />
                  <div className="relative z-10 flex h-[52px] w-[84px] items-center justify-center overflow-hidden rounded-card-xl">
                    <SudarPremiumMark className="min-h-0 min-w-0 scale-[0.24] [&_.sudar-premium-scene]:max-w-none" />
                  </div>
                </>
              ) : (
                <CheckCircle2 className="relative z-10 h-10 w-10 text-white drop-shadow-md" />
              )}
            </div>
            <div className="space-y-2">
