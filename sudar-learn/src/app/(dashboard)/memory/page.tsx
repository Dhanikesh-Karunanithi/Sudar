...
export default async function MemoryPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <section className="hero-block isolate min-h-[200px] flex flex-col justify-between p-8 md:p-10 border-none overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-primary via-primary-hover to-primary rounded-5xl" aria-hidden />
        {/* Uniform scrim keeps headline/body readable across brand palettes and gradient stops */}
        <div className="absolute inset-0 rounded-5xl bg-black/35 ring-1 ring-inset ring-black/10 pointer-events-none" aria-hidden />
        <div className="relative z-10 flex items-center justify-between gap-6 flex-wrap">
          <div className="max-w-xl">
            <h1 className="font-display text-3xl md:text-4xl font-bold text-white mb-3 [text-shadow:0_1px_2px_rgb(0_0_0_/_0.45)]">
              Sudar&apos;s Memory
            </h1>
            <p className="text-white/95 text-lg [text-shadow:0_1px_2px_rgb(0_0_0_/_0.4)]">
          ...
          <div className="w-20 h-20 rounded-full bg-white/20 backdrop-blur flex items-center justify-center shrink-0 ring-1 ring-white/25">
            <Brain className="w-10 h-10 text-white" aria-hidden />
          </div>
        </div>
      </section>
